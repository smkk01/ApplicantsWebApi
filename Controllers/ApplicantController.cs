...
namespace CustomersWebApi.Controllers
{
    ...
    public class ApplicantController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(int id)
        {
           ...
           // var newsoft = _mapper.Map<List<SoftwareExperienceDTO>>(applicant.SoftwareExperienceDetail);
           
           // var newApplicant = _mapper.Map<ApplicantDTO>(applicant);
            // newApplicant.SoftwareExperience.AddRange(newsoft);
        ...
        {
            // var newCustomer = MapApplicantObject(applicant);
           ...
           // newApplicant.SoftwareExperienceDetail.AddRange(newCustomer.SoftwareExperienceDetail);
        ...
        // var newCustomer = MapCustomerObject(customer);
        //List<Experience> experiences = _appDbContext.ExperienceDetail.Where(c => c.ApplicantId == applicant.Id).ToList();
        //_appDbContext.ExperienceDetail.RemoveRange(experiences);

        //_appDbContext.SaveChanges();

        //var updateApplicant = _mapper.Map<Applicant>(applicant);
        //_appDbContext.Applicant.Update(updateApplicant);
        //await _appDbContext.SaveChangesAsync();
        //return Ok(updateApplicant);
